...
$caCert = kubectl exec -n rip-system vault-0 -- cat /var/run/secrets/kubernetes.io/serviceaccount/ca.crt
...
Write-Host "Creating external-secrets role..."
VaultExec "vault policy write external-secrets - <<EOF
