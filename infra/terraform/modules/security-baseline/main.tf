...
variable "enable_guardduty" {
  type        = bool
  description = "Enable GuardDuty. Set false on brand-new AWS accounts until GuardDuty is subscribed."
  default     = false
}
...
data "aws_iam_policy_document" "cloudtrail_bucket" {
  statement {
    ...
    condition {
      ...
      values   = ["arn:aws:cloudtrail:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:trail/${var.name}-cloudtrail"]
    }
  }
